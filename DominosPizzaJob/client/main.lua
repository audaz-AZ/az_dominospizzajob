      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('DominosPizzaJob:pizza1', data2.current.value)
                TriggerServerEvent('DominosPizzaJob:pizza2', data2.current.value)
                TriggerServerEvent('DominosPizzaJob:pizza3', data2.current.value)
                TriggerServerEvent('DominosPizzaJob:pizza4', data2.current.value)
                TriggerServerEvent('DominosPizzaJob:pizza5', data2.current.value)
                TriggerServerEvent('DominosPizzaJob:pizza6', data2.current.value)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('DominosPizzaJob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('DominosPizzaJob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('DominosPizzaJob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('DominosPizzaJob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('DominosPizzaJob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('DominosPizzaJob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('DominosPizzaJob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('DominosPizzaJob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('DominosPizzaJob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('DominosPizzaJob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('DominosPizzaJob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('DominosPizzaJob:hasEnteredMarker', function(zone)
    ...
    if zone == 'crafting' then
      ...
      CurrentActionMsg  = 'Pulsa ~r~[E]~w~ para acceder al menu de crafteo'
      CurrentActionData = {}
    end
...
AddEventHandler('DominosPizzaJob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('DominosPizzaJob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('DominosPizzaJob:hasExitedMarker', LastZone)
            end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'crafting' then
          OpenCraftingMenu()
       end
...
local pizzeria = { x = -561.17, y = -414.13, z = 33.80} --Configuration marker prise de service
